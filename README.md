...
- Power the panel from its own 5V supply (4+ A recommended). Do not power it from the ESP32 5V pin or USB source. The ESP32 can also be powered by the 5V supply.
